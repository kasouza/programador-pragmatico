...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_AMPM = 4,                       /* AMPM  */
  YYSYMBOL_COLLON = 5,                     /* COLLON  */
  YYSYMBOL_OTHER = 6,                      /* OTHER  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_prog = 8,                       /* prog  */
  YYSYMBOL_times = 9,                      /* times  */
  YYSYMBOL_time = 10,                      /* time  */
  YYSYMBOL_hour = 11,                      /* hour  */
  YYSYMBOL_minutes = 12                    /* minutes  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DIGIT", "AMPM",
  "COLLON", "OTHER", "$accept", "prog", "times", "time", "hour", "minutes", YY_NULLPTR
};
